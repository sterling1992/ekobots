...
//   // Colores del gradiente naranja del lado derecho
//   const ORANGE_GRADIENT_FROM = "#FDB813";
//   const ORANGE_GRADIENT_VIA = "#FF9F40";
//   const ORANGE_GRADIENT_TO = "#FF7B35";
...
//           <div className="relative flex items-end justify-center overflow-visible order-2 lg:order-1 h-full">
//             {/* Fondo azul para móvil */}
//             <div
//               className="lg:hidden absolute inset-0"
//               style={{ backgroundColor: EKO_STEM_BLUE }}
//             />

//             {/* Imagen principal - sobresale del banner */}
//             <img
//               src="/7.png"
//               alt="Joven EKO BOTS"
//               className="
//                 absolute
//                 bottom-0
//                 lg:-top-16    /* sale 16px arriba del banner en pantallas grandes */
//                 h-[125%]
//                 sm:h-[130%]
//                 lg:h-[135%]
//                 w-auto
